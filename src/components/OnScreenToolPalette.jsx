...
export function OnScreenToolPalette ({ onTransform, onEmojiSelect, onHandleBullets }) {
  ...
  return (
    <div className={cn("flex items-center justify-center bg-base-100 text-neutral-900 my-1 p-1 space-x-2 group z-50")}>
      {/* Main Toolbar */}
